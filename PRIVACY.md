...
- Health access supports wellbeing activities and hydration records chosen by the user
...
Users can remove local app data or leave a shared household from Settings
